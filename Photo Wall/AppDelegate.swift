...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        Parse.initialize(with: ParseClientConfiguration(block: { (configuration: ParseMutableClientConfiguration) in
            configuration.applicationId = "Photo Wall"
            configuration.clientKey = "aushfiea82374rg8igwoegrf7ayriqgifqe8"
            configuration.server = "https://still-fjord-55821.herokuapp.com/parse"
        }))
        ...
        if(PFUser.current() != nil) {
            ...
            let viewController = storyboard.instantiateViewController(withIdentifier: "PhotoWallNavigationController")
